<template>
  <div class="tableRemoteSearchSelect">
    ...
    <el-popover :visible-arrow="false" placement="bottom-start" :width="popoverWidth" trigger="manual" v-model="visible" ref="popover" popper-class="table-remote-search-popper-zdm">
      <div class="popover-box" @click="clickPopover" @mouse="clickPopover">
        <pagenation-list ref="pageTable" v-model="resultOptions" :data-url="Url" :data-num="dataType" http-method="post" :list-height="400" :searchData="SearchData" :key="listKey" :pageProps="{ layout: 'total, prev, pager, next' }" @reqComplete="reqComplete">
          <div slot="list" class="scroll-bar table-remote-search-select-zdm">
            <div @click="clickPopover">
              ...
              >
                ...
                <el-table-column v-for="result in ResultTableHeader" :key="result.prop" :prop="result.prop" :label="result.label" :width="result.width" :show-overflow-tooltip="true"></el-table-column>
              </el-table>
            </div>
          </div>
        </pagenation-list>
...
export default class extends Vue {
  ...
  private yp: any = {
    // 直接查询的接口,
    fj: '/hisapi/ypsrf/queryXmDic', //中心维护附加项目字典
    sf: '/hisapi/ypsrf/queryZlsfdzDic', //诊疗收费对照字典
    jky: '/hisapi/opypxz/drug/queryPages', //进口药
    bqyz: '/hisapi/ypsrf/queryBqyzYp', //病区医嘱
    mzys_fj: '/hisapi/ypsrf/queryMzYsFj', //门诊医生-辅检
    mzys_cf: '/hisapi/ypsrf/queryDrugsTypk', //门诊医生-开药
    gmy: '/hisapi/ypsrf/queryAllergicDrugsInfo', //过敏药物
    ypcd: '/hisapi/drugscddz/queryPage', //药品产地
    zby: '/hisapi/ypsrf/queryBqyzYpSelfMedicine', // 转自备药
    yzyp: '/hisapi/ypsrf/queryBqyzYp', // 医嘱药品
    ybyp: '/hisapi/ybdzypxx/queryPage', //医保药品
    jyxm: '/hisapi/ypsrf/queryFeeYlsfxmdj', // 检验项目
    gh_jc: '/hisapi/ypsrf/doQueryJsjc', // 检查（挂号）
    ypzt: '/hisapi/ypsrf/queryYpzt', //  常用组套
    ykyp: '/hisapi/ypsrf/queryTagrk', //药库-药品入库
    qtrk: '/hisapi/ypsrf/queryTagcszc', //药库-其他入库
    yptj: '/hisapi/ypsrf/queryTagtj', //药库-药品调价
    ckcl: '/hisapi/ypsrf/queryTagykck', //药库-出库处理非0
    ckclUN: '/hisapi/ypsrf/queryTagykckNoyf', //药库-出库处理0
    ckyp: '/hisapi/selector/query/data?type=outStoreProcess', //药库-出库药品输入法
    cy_fm_jf: '/hisapi/ypsrf/cyFmJc', // 草药 方名/煎法
    // sssq: '/hisapi/optssfl/hospitalInfo', //手术申请
    sssq: '/hisapi/optssfl/allInfo', //手术申请
    jhdw: '/hisapi/selector/query/data?type=purchasingUnit', //药库-进货单位
    ypsl: '/hisapi/selector/query/data?type=drugApply', // 药品申领
    yprk: '/hisapi/selector/query/data?type=drugInStore', // 药品入库
    ypck: '/hisapi/selector/query/data?type=drugOutStore', // 药品出库
    dbsq: '/hisapi/selector/query/data?type=allocationInStore', // 调拨申请
    dbty: '/hisapi/selector/query/data?type=allocationRefund', // 调拨出药
    fytj: '/hisapi/ypsrf/queryModifyPricecFeeYlsfxm', // 费用调价
    tycl: '/hisapi/selector/query/data?type=refundDrug', // 退药处理
    ypyh: '/hisapi/selector/query/data?type=drugMaintenance', // 药品养护
    ykybyp: '/hisapi/selector/query/data?type=medicalInsurance', // 药库-医保药品
    ykypcd: '/hisapi/selector/query/data?type=drugOrigin', // 药库-药品价格-药品产地
    ypxz: '/hisapi/pubbrxz/ypDic', // 药品限制
    fymc: '/hisapi/pubbrxz/fyDic', // 费用限制
    zlgl_sfxm: '/hisapi/ypsrf/queryZlXmDic', //治疗项目-收费项目输入法
    fyjz: '/hisapi/ypsrf/queryDrugAccounting', // 费用记帐
    zlsq: '/hisapi/zlxm/queryZlxmSrf', //治疗申请查询治疗项目输入法
    zycyf: '/hisapi/ypsrf/queryCisyzHerbal', // 住院草药方
    hzzj: '/im-service/doctorTypeWrite/queryAmqcRyKsInfo', // 会诊专家
    zyjz: '/hisapi/selector/query/data?type=bookkeeping', // 住院记账
    fjxmyz: '/hisapi/ypsrf/queryBqyzXm', // 附加项目
  }
  private zt: any = {
    // 前面要输入/的查询
    bqyz: '/hisapi/ypsrf/queryNisQtyz', //病区医嘱
    mzys_fj: '/hisapi/ypsrf/queryMzYsFjZt', //门诊医生-辅检（组套）
    mzys_cf: '/hisapi/ypsrf/ztsrf', //门诊医生-开药（组套）
    gmy: '/hisapi/ypsrf/queryAllergicDrugsInfo', //过敏药物
    yzyp: '/hisapi/ypsrf/queryNisQtyz', // 其他医嘱
    gh_jc: '/hisapi/opmzxx/doQueryJcZtInfo', // 检查组套（挂号）
    fyjz: '/hisapi/ypsrf/queryProjectStackAccounting', // 费用记帐
    zycyf: '/hisapi/ypsrf/queryCisyzHerbal', // 住院草药方
    hzzj: '/im-service/doctorTypeWrite/queryAmqcRyKsInfo', // 会诊专家
    fjxmyz: '/hisapi/ypsrf/queryBqyzXm', // 附加项目
  }
  private xm: any = {
    // 前面要输入.的查询
    bqyz: '/hisapi/ypsrf/queryBqyzXm', //病区医嘱
    gmy: '/hisapi/ypsrf/queryAllergicDrugsInfo', //过敏药物
    zby: '/hisapi/ypsrf/queryBqyzXm', // 转自备药
    yzyp: '/hisapi/ypsrf/queryBqyzXm', // 医嘱药品
    fyjz: '/hisapi/ypsrf/queryExpenseAccounting', // 费用记帐
    zycyf: '/hisapi/ypsrf/queryCisyzHerbal', // 住院草药方
    hzzj: '/im-service/doctorTypeWrite/queryAmqcRyKsInfo', // 会诊专家
    fjxmyz: '/hisapi/ypsrf/queryBqyzXm', // 附加项目
  }
