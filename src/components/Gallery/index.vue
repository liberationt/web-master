<template>
  <div>
    ...
    <el-dialog width="60%" title="icon图库" :visible.sync="outerVisible" append-to-body style="top: 150px">
      <div class="selAlert" v-show="outerVisible">
        <el-tabs v-model="activeName" type="card" @tab-click="handleClick">
          <el-tab-pane label="HIS" name="first">
            <ul class="iconBox">
              <li :class="index == i ? 'active' : ''" v-for="(v, i) in iconList" :key="i" @click="sel(i)">
          ...
          <el-tab-pane label="CIS" name="second">
            <ul class="iconBox">
              <li :class="index == i ? 'active' : ''" v-for="(v, i) in iconCISList" :key="i" @click="selCIS(i)">
                <i class="icon" :class="v"></i>
                <span>{{ i }}</span>
              </li>
            </ul>
...
export default class extends Vue {
  ...
  private iconCISList = [
    ...
    'his-liuguanhushizhan1',
    'his-jizhenliuguanguanli',
    'his-liuguanyishengzhan',
  ]
