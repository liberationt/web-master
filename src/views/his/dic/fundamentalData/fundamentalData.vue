 ...
 * @FilePath: \web-master\src\views\his\dic\fundamentalData\fundamentalData.vue
 -->
      ...
      <el-col class="ht" :span="12">
        <div class="his-module">
          <pagenation-list
            ref="pageTable"
            v-model="tableDatas"
            data-url="/hisapi/sys/sysflagdata/queryPage"
            http-method="post"
      ...
      <el-col class="ht" :span="12">
        <div class="his-module">
          <pagenation-list
            ref="pageTableRef"
            v-model="tableData"
            data-url="/hisapi/sys/sysflagdatavalue/queryPage"
            http-method="post"
