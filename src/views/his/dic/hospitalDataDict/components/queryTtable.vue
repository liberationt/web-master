            ...
            <el-table  :data="tableData"  row-key="id"
                ...
                <el-table-column v-if="actionFlag=='list'" label="操作" :width="actionWidth + 130">
                    <template slot-scope="scope">
                        ...
                        <!-- 删除 -->
                        <el-popconfirm v-if="currItemL.operationsCode.indexOf('delete') != -1" :title="$t('hospitalDataDict.delTipsL')" hideIcon :confirmButtonText="$t('common.delete')" @onConfirm="handleDelData(scope.row)">
                        ...
                        <el-popconfirm v-if="scope.row.enable" :title="$t('physicianRegister.confirmAutomated')" hideIcon :confirmButtonText="$t('common.disable')" @onConfirm="handleStopOrStar(scope.row)">
                            <el-button slot="reference" class="red ml10">
                                <i :size='14' class='icon his-disabled' ></i>
                            </el-button>
                        </el-popconfirm>
                        <el-popconfirm v-if="!scope.row.enable" :title="$t('physicianRegister.confirmDisabled')" hideIcon :confirmButtonText="$t('common.enable')" @onConfirm="handleStopOrStar(scope.row)">
                            <el-button slot="reference" class="red ml10">
