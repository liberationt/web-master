 ...
 * @Description: 医疗器械
 * @FilePath: \web-master\src\views\his\medinsuinterface\medicalDevice\medicalDevice.vue
 -->
...
<template>
  <div class="content">
    <div class="his-module">
      <pagenation-list
        ref="pageTable"
        data-url="/hisapi/shybylqcxx/queryPage"
        v-model="tableData"
      ...
      <div>
        <upload-file
          ...
          :url="pagetype == 1 ? '/hisapi/shybylqcxx/impExcel' : '/hisapi/shybzlxmxx/impExcel'"
          @close="closeModal"
          :fileTypes="fileTypes"
        ></upload-file>
      </div>
