    ...
    <div class="his-module his-small">
      ...
      >
        ...
        >
          ...
          <el-table-column prop="ybid" label="凭证编码"></el-table-column>
          ...
          <el-table-column prop="grxz" label="在退标志">
          ...
          <el-table-column prop="grxj" width="140" label="自负(个人现金支付)"></el-table-column>
...
import { retrieval, reporting } from '@/api/his/medinsuinterface/medicalInsureReport10.ts'
@Component({
