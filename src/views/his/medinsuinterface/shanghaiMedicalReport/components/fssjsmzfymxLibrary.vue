    ...
    <div class="his-module his-small">
      ...
      >
        ...
        >
          ...
          <el-table-column prop="mzhm" label="门诊号"></el-table-column>
          <el-table-column prop="bxid" label="身份证号"></el-table-column>
          ...
          <el-table-column prop="cfhm" label="处方编号"></el-table-column>
          ...
          <el-table-column prop="tymc" width="150" label="药品通用名/材料品牌"></el-table-column>
...
import { retrieval, reporting } from '@/api/his/medinsuinterface/fssjsmzfymxLibrary.ts'
@Component({
