...
<template>
  <div>
    <div class="his-module his-small">
      ...
      <pagenation-list
        ref="pageTable"
        data-url="/hisapi/shybdz/czjmsbb"
        v-model="tableData"
      ...
      >
        ...
        >
          ...
          <el-table-column prop="grxz" label="类别">
            <template slot-scope="scope">
              <div>{{$store.state.webSqlDict.ACCOUNT_CATEGORY_DICT.find(item=> item.dv == scope.row.grxz)&& $store.state.webSqlDict.ACCOUNT_CATEGORY_DICT.find(item=> item.dv==scope.row.grxz).dn}}</div>
            </template>
          </el-table-column>
