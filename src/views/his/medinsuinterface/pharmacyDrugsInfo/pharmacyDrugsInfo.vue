 ...
 * @Description: 
 * @FilePath: \web-master\src\views\his\medinsuinterface\pharmacyDrugsInfo\pharmacyDrugsInfo.vue
 -->
...
export default class extends Vue {
  ...
  private handleImport() {
    ...
    switch (this.activeName) {
      case 'qualitySpec':
        this.headUrl = process.env.VUE_APP_BASE_API + '/hisapi/shybypjcxx/impExcel'
        break
      case 'priceRule':
        this.headUrl = process.env.VUE_APP_BASE_API + '/hisapi/shybypjggz/impExcel'
        break
      case 'purchase':
        this.headUrl = process.env.VUE_APP_BASE_API + '/hisapi/shybypcggz/impExcel'
        break
      case 'delivery':
        this.headUrl = process.env.VUE_APP_BASE_API + '/hisapi/shybyppsqy/impExcel'
        break
      case 'reimbursement':
        this.headUrl = process.env.VUE_APP_BASE_API + '/hisapi/shybybkbxgz/impExcel'
        break
      case 'proportion':
        this.headUrl = process.env.VUE_APP_BASE_API + '/hisapi/shybybblgz/impExcel'
        break
    }
  }
  mounted() {
