    ...
    <div class="his-module his-small">
      <div class="row">
        <div class="label" headInput>
          ...
          <el-divider direction="vertical"></el-divider>
          <div class="querySearch">
            <div class="tag" style="font-size: 13px">归档日期</div>
            <el-date-picker
              type="daterange"
              v-model="currentDate"
              range-separator="-"
      ...
      >
        ...
        <el-table-column label="操作" width="67">
          <template>
            <el-tooltip content="归档" effect="light">
              <el-button size="mini" type="text">
                <i class="icon his-caozuo-Audit"></i>
              </el-button>
            </el-tooltip>
            <el-tooltip content="查看病历" effect="light">
              <el-button size="mini" type="text">
...
export default class extends Vue {
  ...
  private tableData: Array<any> = [
    { zyh: '202007012452', xm: '王小虎', xb: '男', nl: '70岁', cyrq: '2020-07-20', zyts: '10', cyks: '呼吸内科', zfy: '12000', zzd: '左手掌复合痣', zt: '未归档' },
    { zyh: '202007012452', xm: '王小龙', xb: '男', nl: '70岁', cyrq: '2020-07-20', zyts: '10', cyks: '血液内科', zfy: '12000', zzd: '右前臂黑痣', zt: '未归档' },
    { zyh: '202007012452', xm: '王一', xb: '男', nl: '70岁', cyrq: '2020-07-20', zyts: '10', cyks: '骨科', zfy: '12000', zzd: '肩黑素细胞痣', zt: '未归档' },
    { zyh: '202007012452', xm: '王二', xb: '男', nl: '70岁', cyrq: '2020-07-20', zyts: '10', cyks: '小儿科', zfy: '12000', zzd: '手黑素细胞痣', zt: '未归档' }
  ]
