    ...
    <el-row class="ht" :gutter="10">
      ...
      <el-col class="ht" :span="4">
        <div class="his-module">
          ...
          <ul v-if="checked1.length" class="list1 scroll-bar">
            <li
          ...
          <div v-else class="no-data">
            <img src="@/assets/main-img/no-data.png">
            <p>暂无数据</p>
          </div>
      ...
      <el-col class="ht" :span="6">
        <div class="his-module">
          ...
          <el-checkbox-group v-if="list2.length" v-model="checked2" class="check-list scroll-bar">
            <div
...
export default class extends Vue {
  ...
  created() {
    this.listSlotHeight =this.PageHeight - 116
  }
  mounted() {
    // this.getLists()
    this.getBtList()
