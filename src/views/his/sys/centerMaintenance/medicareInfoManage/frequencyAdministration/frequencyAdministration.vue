 ...
 * @LastEditTime: 
 * @Description:给药频次维护
 * @FilePath: \web-master\src\views\his\sys\centerMaintenance\medicareInfoManage\frequencyAdministration\frequencyAdministration.vue
-->
<template>
  <div class="content">
    <el-row class="ht" :gutter="10">
      <el-col class="ht" :span="18">
        <div class="his-module his-small" style="padding: 8px 10px">
          ...
          <pagenation-list
            ref="pageTable"
            data-url="/hisapi/dicsypc/queryPage"
            http-method="post"
            v-model="tableData"
