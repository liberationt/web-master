 ...
 * @LastEditors: zhml
 * @Description: 
 * @FilePath: \web-master\src\views\his\op\guidance\shift\shift.vue
 -->
<template>
  <div class="content">
    <el-row class="ht" :gutter="10">
      <el-col class="ht" :span="16">
        <div class="his-module">
          <!--    <pagenation-list ref="pageTable" data-url="/hisapi/opbcsj/findList" v-model="list" :searchData="searchData" http-method="post" :list-height="listSlotHeight"> -->
  ...
  <template slot-scope="scope">
    <el-popconfirm class="ml10" hideIcon :confirmButtonText="$t('common.delete')" :cancelButtonText="$t('common.cancel')" :title="$t('common.delTip')" @onCancel="handleCancel" @onConfirm="handleOk(scope.row)">
