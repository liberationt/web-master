 ...
 * @LastEditors: 曹俊
 * @Description:
 * @FilePath: \web-master\src\views\his\op\guidance\reception\reception.vue
 -->
    ...
    <el-row class="ht" :gutter="10">
      <el-col class="ht" :span="16">
        <div class="his-module">
          <pagenation-list ref="pageTable" data-url="/hisapi/opfwtxx/queryPage" v-model="list" :list-height="listSlotHeight" :searchData="searchData" http-method="post">
              ...
              <el-table-column :label="$t('common.action')" width="100" align="center">
                <template slot-scope="scope">
                  <el-tooltip :content="scope.row.sfky == '0' ? $t('common.disable') : $t('common.enable')" placement="bottom" effect="light">
                    <el-popconfirm class="ml10" hideIcon :confirmButtonText="scope.row.sfky == '0' ? $t('common.disable') : $t('common.confirm')" :cancelButtonText="$t('common.cancel')" :title="scope.row.sfky == '1' ? $t('common.enableTip') : $t('common.disableTip')" @onCancel="handleCancel" @onConfirm="handleOk(scope.row)">
                  ...
                  <el-tooltip :content="$t('common.delete')" effect="light">
                    <el-popconfirm class="ml8" hideIcon :cancelButtonText="$t('common.cancel')" :confirmButtonText="$t('common.confirm')" :title="$t('sysManage.confirmDeleted')" @onConfirm="handleDelete(scope.row)">
