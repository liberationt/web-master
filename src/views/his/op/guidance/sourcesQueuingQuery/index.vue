<template>
  <div class="content screen ht">
    <pagenation-list class="his-module" ref="pageTable" data-url="/hisapi/opzspdxx/waitQueueResult" v-model="tabledata" :searchData="searchData" :list-height="listSlotHeight" :pageProps="pageProps" http-method="post">
