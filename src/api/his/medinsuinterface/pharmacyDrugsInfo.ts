 ...
 * @LastEditors: 曹俊
 * @Description: 
 * @FilePath: \web-master\src\api\his\medinsuinterface\pharmacyDrugsInfo.ts
 */
...
export const queryQualitySpecPage = (data: any) => {
    return axios.request({
        url: "/hisapi/shybypjcxx/queryPage",
        data,
        method: "post" 
    })
};
...
export const queryPriceRulePage = (data: any) => {
    return axios.request({
        url: "/hisapi/shybypjggz/queryPage",
        data,
        method: "post" 
    })
};
...
export const queryPurchasePage = (data: any) => {
    return axios.request({
        url: "/hisapi/shybypcggz/queryPage",
        data,
        method: "post" 
    })
};
...
export const queryDeliveryPage = (data: any) => {
    return axios.request({
        url: "/hisapi/shybyppsqy/queryPage",
        data,
        method: "post" 
    })
};
...
export const queryDreimbursementPage = (data: any) => {
    return axios.request({
        url: "/hisapi/shybybkbxgz/queryPage",
        data,
        method: "post" 
    })
};
...
export const queryProportionPage = (data: any) => {
    return axios.request({
        url: "/hisapi/shybybblgz/queryPage",
        data,
        method: "post" 
    })
};
...
export const addDataCode = (data: any) => {
    return axios.request({
        url: "/hisapi/shybdata0202/unifiedAdd",
        data,
        method: "post"
    })
};
...
export const editDataCode = (data: any) => {
    return axios.request({
        url: "/hisapi/shybdata0202/unifiedEdit",
        data,
        method: "post",
        headers: {
...
export const enableStatus = (data: any) => {
    return axios.request({
        url: "/hisapi/shybdata0202/editStopFlag",
        data,
        method: "post"
    })
};
...
export const queryPage = (data: any) => {
    return axios.request({
        url: "/hisapi/shybdata0202/unifiedQueryPage",
        data,
        method: "post"
    })
};
