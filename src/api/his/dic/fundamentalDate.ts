...
export const addzNewDic = (data: any) => {
    return request({
        url: '/hisapi/sys/sysflagdata/add',
        method: 'post',
        data
    })
}
...
export const getzNewDic = (data: any) => {
    return request({
        url: '/hisapi/sys/sysflagdata/getNewData',
        method: 'post',
        data
    })
}
...
export const getzAllDicNewDic = (data: any) => {
    return request({
        url: '/hisapi/sys/sysflagdata/getAllDic',
        method: 'post',
        data
    })
}
...
export const queryzNewDic = (data: any) => {
    return request({
        url: '/hisapi/sys/sysflagdata/queryPage',
        method: 'post',
        data
    })
}
...
export const addfNewDic = (data: any) => {
    return request({
        url: '/hisapi/sys/sysflagdatavalue/add',
        method: 'post',
        data
    })
}
...
export const editfNewDic = (data: any) => {
    return request({
        url: '/hisapi/sys/sysflagdatavalue/edit',
        method: 'post',
        data
    })
}
...
export const enableMenu = (data: any) => {
    return request({
        url: '/hisapi/sys/sysflagdatavalue/editEnable',
        method: 'post',
        data
    })
}
...
export const deleteHospitalDic = (id: number) => {
    return request({
        url: '/hisapi/sys/dicgbsj01/delete/' + id,
        method: 'post',
    })
}
...
export const getHospitalDetail = (id: number) => {
    return request({
        url: '/hisapi/sys/dicgbsj02/detail/' + id,
        method: 'post'
    })
}
...
export const startHospitalDetail = (id: number) => {
    return request({
        url: '/hisapi/sys/dicgbsj02/open/' + id,
        method: 'post'
    })
}
// 停用医院字典项
export const stopHospitalDetail = (id: number) => {
    return request({
        url: '/hisapi/sys/dicgbsj02/stop/' + id,
        method: 'post'
    })
}
...
export const searchHospitalById = (id: any) => {
    return request({
        url: '/hisapi/sys/dicgbsj02/queryChild/' + id,
        method: 'post'
    })
}
//新增sql字典
...
export const enableSqlDict = (data:any) => {
    return request({
        url:`/hisapi/sysdictconfig/enable/${data.dictId}`,
        method: 'post',
    })
}
//停用sql字典
export const stopSqlDict = (data:any) => {
    return request({
        url:`/hisapi/sysdictconfig/stop/${data.dictId}`,
        method: 'post',
    })
}
