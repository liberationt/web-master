 ...
 * @LastEditors: 张文奇
 * @Description: 
 * @FilePath: \web-master\src\api\his\user\workerManager.ts
 */
...
export const addEhrservicepersonal= (data: any) =>
    axios.request({
        url: "/hisapi/ehrservicepersonal/add",
        method: "post",
        data
    });
...
export const lock = (data: any) =>
    axios.request({
        url: "/hisapi/ehrservicepersonal/lock",
        method: "post",
        data
    });
...
export const unlock = (data: any) =>
    axios.request({
        url: "/hisapi/ehrservicepersonal/unlock",
        method: "post",
        data
    });
...
export const editEhrservicepersonal = (data: any) =>
    axios.request({
        url: "/hisapi/ehrservicepersonal/edit",
        method: "post",
        data
    });
...
export const querySysgroupList = (data: any) =>
    axios.request({
        url: "/hisapi/ehrservicepersonal/queryPage",
        method: "post",
        data
    });
...
export const checkEmpNo = (data: any) =>
    axios.request({
        url: "/hisapi/ehrservicepersonal/check",
        method: "post",
        data
    });
...
export const checkCert = (data: any) =>
    axios.request({
        url: "/hisapi/ehrservicepersonal/validCret",
        method: "post",
        data
    });
