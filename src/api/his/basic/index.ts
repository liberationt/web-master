...
export const getRegion = () => {
  return request({
    url: '/system-service/sysdictconfig/getRegion',
    method: 'post',
  })
}
// 获取新的行政区划
export const getAllRegion = () => {
  return request({
    url: '/system-service/sysdictconfig/getAllRegion',
    method: 'post',
  })
}
...
export const getDesign = (name: any) => {
  return request({
    url: `/hisapi/quecxfb/getDesign?enName=${name}`,
    method: 'post',
  })
}
...
export const queryfyKc = (data: any) => {
  return request({
    url: '/hisapi/drugsypxx/queryfyKc',
    method: 'post',
    data,
  })
}
...
export const init = (data: any) => {
  return request({
    url: '/hisapi/pharmacy/public/init/check',
    method: 'post',
    data,
    headers: {
      'Res-Type': 'special',
