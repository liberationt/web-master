...
export const lyksExists = (data: any) => {
    return request({
        url: '/hisapi/pharmacy/public/query/lyks/exists',
        method: 'post',
        data
    })
}
...
export const queryDispensingWard = (data: any) => {
    return request({
        url: '/hisapi/doctor/advice/query',
        method: 'post',
        data
    })
}
...
export const queryTjd = (data: any) => {
    return request({
        url: '/hisapi/doctor/advice/query/tjd',
        method: 'post',
        data
    })
}
...
export const queryPatient = (data: any) => {
    return request({
        url: '/hisapi/doctor/advice/query/br',
        method: 'post',
        data
    })
}
...
export const queryDrugDetail = (data: any) => {
    return request({
        url: '/hisapi/doctor/advice/query/detail',
        method: 'post',
        data,
        headers: {
...
export const adviceDispensing = (data: any) => {
    return request({
        url: '/hisapi/doctor/advice/grant/drug',
        method: 'post',
        data,
        headers: {
            "Content-Type": "application/json"
...
export const adviceBackFull = (data: any) => {
    return request({
        url: '/hisapi/doctor/advice/back/full',
        method: 'post',
        data,
        headers: {
            "Content-Type": "application/json"
