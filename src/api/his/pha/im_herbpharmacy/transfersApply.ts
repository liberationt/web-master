 ...
 * @LastEditors: 曹俊
 * @Description: 
 * @FilePath: \web-master\src\api\his\pha\im_herbpharmacy\transfersApply.ts
 */ 
...
export const save = (data: any) => {
    return request({
        url: '/hisapi/allocate/apply/save',
        method: 'post',
        data,
        headers: {
            "Content-Type": "application/json"
...
export const exists = (data: any) => {
    return request({
        url: '/hisapi/allocate/apply/check/is/exists',
        method: 'post',
        data
    })
}
...
export const remove = (data: any) => {
    return request({
        url: '/hisapi/drug/in/store/remove',
        method: 'post',
        data
    })
}
...
export const detailList = (data: any) => {
    return request({
        url: '/hisapi/allocate/apply/query/detail',
        method: 'post',
        data
    })
}
...
export const applyCommit = (data: any) => {
    return request({
        url: '/hisapi/allocate/apply/commit',
        method: 'post',
        data,
        headers: {
            "Content-Type": "application/json"
