 ...
 * @LastEditors: 曹俊
 * @Description: 
 * @FilePath: \web-master\src\api\his\pha\im_herbpharmacy\transfersBackMedicine.ts
 */ 
...
export const save = (data: any) => {
    return request({
        url: '/hisapi/allocate/return/drug/save',
        method: 'post',
        data,
        headers: {
            "Content-Type": "application/json"
...
export const removeApply = (data: any) => {
    return request({
        url: '/hisapi/allocate/apply/remove',
        method: 'post',
        data
    })
}
...
export const exists = (data: any) => {
    return request({
        url: '/hisapi/allocate/return/drug/check/is/exists',
        method: 'post',
        data
    })
}
...
export const detail= (data: any) => {
    return request({
        url: '/hisapi/allocate/return/drug/get',
        method: 'post',
        data
    })
}
...
export const remove = (data: any) => {
    return request({
        url: '/hisapi/allocate/return/drug/remove',
        method: 'post',
        data
    })
}
...
export const detailList = (data: any) => {
    return request({
        url: '/hisapi/allocate/return/drug/query/detail',
        method: 'post',
        data
    })
}
...
export const applyCommit = (data: any) => {
    return request({
        url: '/hisapi/allocate/return/drug/commit',
        method: 'post',
        data,
        headers: {
            "Content-Type": "application/json"
