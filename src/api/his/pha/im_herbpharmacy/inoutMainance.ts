...
export const saveInPha = (data: any) => {
    return request({
        url: '/hisapi/inout/management/in/save',
        method: 'post',
        data
    })
}
...
export const saveOutPha = (data: any) => {
    return request({
        url: '/hisapi/inout/management/out/save',
        method: 'post',
        data
    })
}
...
export const deleteInStyle = (data: any) => {
    return request({
        url: '/hisapi/inout/management/in/delete',
        method: 'post',
        data
    })
}
...
export const deleteOutStyle = (data: any) => {
    return request({
        url: '/hisapi/inout/management/out/delete',
        method: 'post',
        data
    })
}
...
export const isRepet = (data: any) => {
    return request({
        url: '/hisapi/inout/management/check/repeat/inspection',
        method: 'post',
        data,
        headers: {
          'Res-Type': 'special'
...
export const isUsing = (data: any) => {
    return request({
        url: '/hisapi/inout/management/do/verified/using',
        method: 'post',
        data
    })
}
...
export const getDatas = (data: any) => {
    return request({
        url: '/hisapi/quecxfb/getByOneEntity',
        method: 'post',
        data,
        // headers: {
        //     "Content-Type": "application/json"
...
export const getPxh = (data: any) => {
    return request({
        url: `/hisapi/inout/management/get/next/pxh?type=${data.type}&yfsb=${data.yfsb}`,
        method: 'post'
    })
}
