...
export const reconInit = (data: any) => {
    return request({
        url: '/hisapi/reconciliation/init',
        method: 'post',
        data
    })
}
...
export const saveInventory = (data: any) => {
    return request({
        url: '/hisapi/reconciliation/query',
        method: 'post',
        data
    })
}
...
export const queryDate = (data: any) => {
    return request({
        url: '/hisapi/reconciliation/query/date',
        method: 'post',
        data
    })
}
...
export const queryDetail = (data: any) => {
    return request({
        url: '/hisapi/reconciliation/query/detail',
        method: 'post',
        data
    })
}
...
export const detailList = (data: any) => {
    return request({
        url: '/hisapi/reconciliation/query/detail/list',
        method: 'post',
        data
    })
}