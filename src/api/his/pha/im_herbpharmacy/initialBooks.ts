...
export const queryTotal = (data: any) => {
    return request({
        url: '/hisapi/pharmacy/account/query/total/money',
        method: 'post',
        data
    })
}
...
export const saveInventory = (data: any) => {
    return request({
        url: '/hisapi/pharmacy/account/do/save/inventory',
        method: 'post',
        data,
        headers: {
            "Content-Type": "application/json"
...
export const PhaTransfer = (data: any) => {
    return request({
        url: '/hisapi/pharmacy/account/do/save/transfer',
        method: 'post',
        data
    })
}
...
export const isInitial = (data: any) => {
    return request({
        url: '/hisapi/pharmacy/account/initial',
        method: 'post',
        data,
        headers: {
            'Res-Type': 'special' 
...
export const init = (data: any) => {
    return request({
        url: '/hisapi/drug/info/maintenance/query/system/init',
        method: 'post',
        data,
        headers: {
            'Res-Type': 'special'
...
export const add = (data: any) => {
    return request({
        url: `/hisapi/pharmacy/account/add?kcsb=${data}`,
        method: 'post'
    })
}
