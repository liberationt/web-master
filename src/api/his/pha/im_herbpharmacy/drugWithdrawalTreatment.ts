 ...
 * @LastEditors: 曹俊
 * @Description: 
 * @FilePath: \web-master\src\api\his\pha\im_herbpharmacy\drugWithdrawalTreatment.ts
 */ 
...
export const queryHouse = (data: any) => {
    return request({
        url: `/hisapi/pharmacy/public/query/store/house?yfsb=${data}`,
        method: 'post'
    })
}
...
export const queryTyCkfs = (data: any) => {
    return request({
        url: `/hisapi/medicines/refund/query/way?yksb=${data}`,
        method: 'post',
        data
    })
}
...
export const pharmacyApply = (data: any) => {
    return request({
        url: `/hisapi/medicines/refund/pharmacy/apply/select`,
        method: 'post',
        data
    })
}
...
export const initDateQuery = (data: any) => {
    return request({
        url: `/hisapi/pharmacy/public/get/default/month?yfsb=${data}`,
        method: 'post'
    })
}
...
export const dateQuery = (data: any) => {
    return request({
        url: `/hisapi/pharmacy/public/date/query`,
        method: 'post',
        data
    })
}
...
export const queryKcsl = (data: any) => {
    return request({
        url: `/hisapi/allocate/apply/query/target/kcsl`,
        method: 'post',
        data
    })
}
...
export const save = (data: any) => {
    return request({
        url: '/hisapi/medicines/refund/save/medicines/apply',
        method: 'post',
        data,
        headers: {
            "Content-Type": "application/json"
...
export const verification = (data: any) => {
    return request({
        url: '/hisapi/medicines/apply/save/pre/verification',
        method: 'post',
        data
    })
}
...
export const detail= (data: any) => {
    return request({
        url: '/hisapi/medicines/refund/query/detail',
        method: 'post',
        data
    })
}
...
export const remove = (data: any) => {
    return request({
        url: '/hisapi/medicines/refund/remove/apply/data',
        method: 'post',
        data
    })
}
...
export const detailList = (data: any) => {
    return request({
        url: '/hisapi/medicines/refund/medicine/detail',
        method: 'post',
        data
    })
}
...
export const commit = (data: any) => {
    return request({
        url: '/hisapi/allocate/apply/submit',
        method: 'post',
        data
    })
}
...
export const applyCommit = (data: any) => {
    return request({
        url: '/hisapi/medicines/refund/apply/commit',
        method: 'post',
        data,
        headers: {
            "Content-Type": "application/json"
...
export const importData = (data: any) => {
    return request({
        url: '/hisapi/medicines/refund/import/history/data',
        method: 'post',
        data
    })
}