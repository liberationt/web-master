 ...
 * @LastEditors: 曹俊
 * @Description: 
 * @FilePath: \web-master\src\api\his\pha\im_herbpharmacy\inventory.ts
 */ 
...
export const queryPdData = (data: any) => {
    return request({
        url: `/hisapi/check/process/query/data?ckbh=${data.ckbh}&pddh=${data.pddh}&yfsb=${data.yfsb}&hzwc=${data.hzwc}&pdwc=${data.pdwc}`,
        method: 'post',
        // headers: {
...
export const queryStatePc = (data: any) => {
    return request({
        url: `/hisapi/check/process/query/state?ckbh=${data.ckbh}&pddh=${data.pddh}&yfsb=${data.yfsb}&hzwc=${data.hzwc}&pdwc=${data.pdwc}`,
        method: 'post',
        // data,
        // headers: {
        //     "Content-Type": "application/json"
...
export const startProcess = (data: number) => {
    return request({
        url: `/hisapi/check/process/start?yfsb=${data}`,
        method: 'post',
        headers: {
            "Res-Type": "special"
        }
...
export const queryKcpdPc = (data: number) => {
    return request({
        url: `/hisapi/check/process/query/param?yfsb=${data}`,
        method: 'post',
    })
}
// saveDispensing-发药
...
export const querySfpdfp = (data: any) => {
    return request({
        url: '/hisapi/check/process/query/sfpdfp',
        method: 'post',
        data
    })
}
...
export const savePharmacyInventoryFP = (data: any) => {
    return request({
        url: '/hisapi/check/process/pdfp/save',
        method: 'post',
        data,
        headers: {
            "Content-Type": "application/json"
...
export const romoveProcess = (data: any) => {
    return request({
        url: '/hisapi/check/process/remove',
        method: 'post',
        data
    })
}
...
export const summaryProcess = (data: any) => {
    return request({
        url: '/hisapi/check/process/summary',
        method: 'post',
        data
    })
}
...
export const queryWcje = (data: any) => {
    return request({
        url: '/hisapi/check/process/query/wcje',
        method: 'post',
        data
    })
}
...
export const savePdwc = (data: any) => {
    return request({
        url: '/hisapi/check/process/save/pdwc',
        method: 'post',
        data
    })
}
...
export const updatePdsl = (data: any) => {
    return request({
        url: '/hisapi/check/process/update/pdsl',
        method: 'post',
        data,
        headers: {
            "Content-Type": "application/json"
