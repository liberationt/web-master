...
export const inoutWay = (data: any) => {
    return request({
        url: '/hisapi/pharmacy/public/inout/way',
        method: 'post',
        data
    })
}
...
export const removeApply = (data: any) => {
    return request({
        url: '/hisapi/drug/out/store/remove',
        method: 'post',
        data
    })
}
...
export const detail = (data: any) => {
    return request({
        url: '/hisapi/drug/in/store/get/detail',
        method: 'post',
        data
    })
}
...
export const exists = (data: any) => {
    return request({
        url: '/hisapi/drug/in/store/verify/is/exists',
        method: 'post',
        data
    })
}
...
export const price = (data: any) => {
    return request({
        url: '/hisapi/drug/in/store/verify/price',
        method: 'post',
        data
    })
}
...
export const detailList = (data: any) => {
    return request({
        url: '/hisapi/drug/in/store/query/detail/list',
        method: 'post',
        data
    })
}
...
export const commit = (data: any) => {
    return request({
        url: '/hisapi/drug/in/store/commit',
        method: 'post',
        data
    })
}
