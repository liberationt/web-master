...
export const callIn = (data: any) => {
    return request({
        url: '/hisapi/drug/info/maintenance/import',
        method: 'post',
        data
    })
}
...
export const searchDrug = (data: any) => {
    return request({
        url: '/hisapi/drug/info/maintenance/get',
        method: 'post',
        data
    })
}
...
export const editDrugInfo = (data: any) => {
    return request({
        url: '/hisapi/drug/info/maintenance/save',
        method: 'post',
        data
    })
}
...
export const handleStatus = (data: any) => {
    return request({
        url: '/hisapi/drug/info/maintenance/update/status',
        method: 'post',
        data
    })
}