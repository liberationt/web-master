 ...
 * @LastEditors: 曹俊
 * @Description: 
 * @FilePath: \web-master\src\api\his\pha\im_herbpharmacy\allocationOutbound.ts
 */ 
...
export const checkSubmit = (data: any) => {
    return request({
        url: '/hisapi/allocate/out/check/submit',
        method: 'post',
        data
    })
}
...
export const detailList = (data: any) => {
    return request({
        url: '/hisapi/allocate/out/get/detail',
        method: 'post',
        data
    })
}
...
export const applyCommit = (data: any) => {
    return request({
        url: '/hisapi/allocate/out/commit',
        method: 'post',
        data,
        headers: {
            "Content-Type": "application/json"
