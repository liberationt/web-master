 ...
 * @LastEditors: 曹俊
 * @Description: 
 * @FilePath: \web-master\src\api\his\pha\im_herbpharmacy\readingBill.ts
 */ 
...
export const queryDate = (data: any) => {
    return request({
        url: `/hisapi/month/end/accounts/query/date?yfsb=${data}`,
        method: 'post',
    })
}
...
export const monthlyBalance = (data: any) => {
    return request({
        url: '/hisapi/month/end/accounts/save',
        method: 'post',
        data,
        // headers: {
