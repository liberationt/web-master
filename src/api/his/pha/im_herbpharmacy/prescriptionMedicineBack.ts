 ...
 * @LastEditors: 曹俊
 * @Description: 
 * @FilePath: \web-master\src\api\his\pha\im_herbpharmacy\prescriptionMedicineBack.ts
 */ 
...
export const cancelDispensing = (data: number) => {
    return request({
        url: `/hisapi/cancel/dispensing/query/cf/detail?cfsb=${data}`,
        method: 'post'
    })
}
...
export const saveCancelDispensing = (data: any) => {
    return request({
        url: '/hisapi/cancel/dispensing/save/back/medicine',
        method: 'post',
        data
    })
}
...
export const saveMedicine = (data: any) => {
    return request({
        url: '/hisapi/cancel/dispensing/save/back/part/medicine',
        method: 'post',
        data,
        headers: {
            "Content-Type": "application/json"
...
export const queryRefund = (data: any) => {
    return request({
        url: `/hisapi/cancel/dispensing/query/refund/detail?cfsb=${data}`,
        method: 'post',
        data
    })
}
