...
export const verifyIsExists = (data: any) => {
    return request({
        url: '/hisapi/drug/out/store/verify/is/exists',
        method: 'post',
        data
    })
}
...
export const saveApply = (data: any) => {
    return request({
        url: '/hisapi/drug/out/store/save',
        method: 'post',
        data,
        headers: {
            "Content-Type": "application/json"
...
export const queryDetail= (data: any) => {
    return request({
        url: '/hisapi/drug/out/store/query/detail',
        method: 'post',
        data
    })
}
...
export const queryDrug= (data: any) => {
    return request({
        url: '/hisapi/drug/out/store/query/drug/detail',
        method: 'post',
        data
    })
}
...
export const applyCommit = (data: any) => {
    return request({
        url: '/hisapi/drug/out/store/commit',
        method: 'post',
        data,
        headers: {
            "Res-Type": "special"
