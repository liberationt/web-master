 ...
 * @LastEditors: 曹俊
 * @Description: 
 * @FilePath: \web-master\src\api\his\pha\drugs_apply\drugsApply.ts
 */ 
...
export const removeApply = (data: any) => {
    return request({
        url: '/hisapi/medicines/apply/remove/apply/data',
        method: 'post',
        data
    })
}
...
export const getCkfs = (data: any) => {
    return request({
        url: '/hisapi/medicines/apply/get/ckfs',
        method: 'post',
        data
    })
}
...
export const queryDetail = (data: any) => {
    return request({
        url: '/hisapi/medicines/apply/query/out/detail',
        method: 'post',
        data
    })
}
...
export const getYfyk = (data: any) => {
    return request({
        url: '/hisapi/medicines/apply/get/kcsl/yfyk',
        method: 'post',
        data
    })
}
...
export const detail = (data: any) => {
    return request({
        url: '/hisapi/medicines/apply/query/detail',
        method: 'post',
        data
    })
}
...
export const updateApplyData = (data: any) => {
    return request({
        url: '/hisapi/medicines/apply/update/apply/data',
        method: 'post',
        data
    })
}
...
export const saveApply = (data: any) => {
    return request({
        url: '/hisapi/medicines/apply/save/medicines/apply',
        method: 'post',
        data,
        headers: {
            "Content-Type": "application/json"
...
export const queryStoreLess = (data: any) => {
    return request({
        url: '/hisapi/medicines/apply/query/store/less',
        method: 'post',
        data
    })
}
...
export const applyCommit = (data: any) => {
    return request({
        url: '/hisapi/medicines/apply/save/medicines/apply/commit',
        method: 'post',
        data,
        headers: {
            "Content-Type": "application/json"
