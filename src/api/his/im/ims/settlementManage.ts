...
export const getSettlementData = (data: any) =>
	axios.request({
		url: '/hisapi/balanceAccounts/queryBalanceAccountsList',
		method: 'post',
		data
	});
...
//   axios.request({
//     url: '/hisapi/balanceAccounts/queryPatientBalanceAccountsBaseInfo',
//     method: 'post',
//     data
//   })
...
export const getAccountsSettle = (data: any) =>
	axios.request({
		url: '/hisapi/balanceAccounts/queryBalanceAccountsSettle',
		method: 'post',
		data
	});
...
export const getInvoice = () =>
	axios.request({
		url: '/hisapi/costManage/getCurrentInvoice',
		method: 'post'
	});
...
export const saveSettleAccounts = (data: any) =>
	axios.request({
		url: '/hisapi/balanceAccounts/saveSettleAccounts',
		method: 'post',
		data,
		headers: {
...
export const accountCancel = (data: any) =>
	axios.request({
		url: '/hisapi/balanceAccounts/patientBalanceAccountsCancel',
		method: 'post',
		data,
		headers: {
			'Content-Type': 'application/json'
...
export const doQueryZyfpdy = (data: any) =>
	axios.request({
		url: '/hisapi/balanceAccounts/doQueryZyfpdy',
		method: 'post',
		data
	});
