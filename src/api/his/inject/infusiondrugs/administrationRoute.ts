...
export const queryUnchecked = (data: any) => {
    return request({
        url: `/hisapi/drug/usage/query/unchecked?yfsb=${data.yfsb}&value=${data.value}`,
        method: 'post',
    })
}
...
export const queryChecked = (data: any) => {
    return request({
        url: `/hisapi/drug/usage/query/checked?yfsb=${data.yfsb}&value=${data.value}`,
        method: 'post'
    })
}
...
export const drugUsageAdd = (data: any) => {  
    return request({
        url: `/hisapi/drug/usage/add?yfsb=${data.yfsb}&ids=${data.ids}`,
        method: 'post'
    })
}
...
export const drugUsageRemove = (data: any) => {
    return request({
        url: `/hisapi/drug/usage/remove?yfsb=${data.yfsb}&ids=${data.ids}`,
        method: 'post'
    })
}
