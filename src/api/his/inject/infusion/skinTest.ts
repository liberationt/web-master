...
export const aSaveSkinTest = (data: any) => {
  return axios.request({
    url: '/hisapi/skinxm/doSaveSkinTest',
    method: 'post',
    data
  })
}
...
export const aUpdateSkinTest = (data: any) => {
  return axios.request({
    url: '/hisapi/skinxm/doUpdateSkinTest',
    method: 'post',
    data
  })
}
...
export const aDeleteSkinTest = (data: any) => {
  return axios.request({
    url: '/hisapi/skinxm/doDeleteSkinTest',
    method: 'post',
    data
  })
}
...
export const aQueryLdsfxmList = (data: any) => {
  return axios.request({
    url: '/hisapi/skinxmldsfxm/doQueryLdsfxmList',
    method: 'post',
    data
  })
}
...
export const aSaveLdsfxm = (data: any) => {
  return axios.request({
    url: '/hisapi/skinxmldsfxm/doSaveLdsfxm',
    method: 'post',
    data,
    headers: {
...
export const aDeleteLdsfxm = (data: any) => {
  return axios.request({
    url: '/hisapi/skinxmldsfxm/doDeleteLdsfxm',
    method: 'post',
    data
  })
}
...
export const aQueryUnSkinTest = (data: any) => {
  return axios.request({
    url: '/hisapi/skindjzb/doQueryUnSkinTest',
    method: 'post',
    data
  })
}
...
export const aPsSaveRegister = (data: any) => {
  return axios.request({
    url: '/hisapi/skindjzb/doPsSaveRegist',
    method: 'post',
    data,
    headers: {
      'Content-Type': 'application/json'
...
export const aDoPsProcess = (data: any) => {
  return axios.request({
    url: '/hisapi/skindjzb/doPsProcess',
    method: 'post',
    data
  })
}
...
export const aPsFinish = (data: any) => {
  return axios.request({
    url: '/hisapi/skindjzb/doPsFinish',
    method: 'post',
    data
  })
}
...
export const aPsCancel = (data: any) => {
  return axios.request({
    url: '/hisapi/skindjzb/doPsCancel',
    method: 'post',
    data
  })
}
...
export const aQueryDjmx = (data: any) => {
  return axios.request({
    url: '/hisapi/skindjzb/doQueryDjmx',
    method: 'post',
    data
  })
}
...
export const aQueryAllDjCount = (data: any) => {
  return axios.request({
    url: '/hisapi/skindjzb/doQueryAllDjCount',
    method: 'post',
    data
  })
}
...
export const aQueryPsAllergy = (data: any) => {
  return axios.request({
    url: '/hisapi/skindjzb/doQueryPsAllergy',
    method: 'post',
    data
  })
}