...
export const getPatientDetail = (data: any) => {
    return request({
        url: '/hisapi/pubbrxz/queryDetail',
        method: 'post',
        data,
    })
}
...
export const getCostDetail = (data: any) => {
    return request({
        url: '/hisapi/pubbrxz/queryFyxzList',
        method: 'post',
        data,
    })
}
...
export const getDrugLimit = (data: any) => {
    return request({
        url: '/hisapi/pubbrxz/queryYpxzList',
        method: 'post',
        data,
    })
}
...
export const getSelfProportion = (data: any) => {
    return request({
        url: '/hisapi/pubbrxz/queryBrxzZfbl',
        method: 'post',
        data,
    })
}
