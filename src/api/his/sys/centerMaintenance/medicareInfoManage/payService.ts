...
export const verify = (data: any) => {
    return request({
        url: '/hisapi/dicsfxmlb/chargingProjectsVerification',
        method: 'post',
        data,
    })
}
...
export const mergerProject = (data: any) => {
    return request({
        url: '/hisapi/dicsfxmlb/consolidationProjects',
        method: 'post',
        data,
    })
}
...
export const cancelDetail = (data: any) => {
    return request({
        url: '/hisapi/dicsfxmlb/logoutMedicalItems',
        method: 'post',
        data,
    })
}
...
export const costAliasList = (data: any) => {
    return request({
        url: '/hisapi/dicsfxmlb/queryPubFybm',
        method: 'post',
        data,
    })
}
...
export const chargeProjectDetail = (data: any) => {
    return request({
        url: '/hisapi/dicsfxmlb/queryGyYlsfDetail',
        method: 'post',
        data,
    })
}
...
export const searchProject = (data: any) => {
    return request({
        url: '/hisapi/dicsfxmlb/queryMedicalProject',
        method: 'post',
        data,
    })
}
...
export const saveProject = (data: any) => {
    return request({
        url: '/hisapi/dicsfxmlb/saveChargingProjects',
        method: 'post',
        data,
    })
}
...
export const saveDetailProject = (data: any) => {
    return request({
        url: '/hisapi/dicsfxmlb/saveCostDetail',
        method: 'post',
        data,
        headers: {
