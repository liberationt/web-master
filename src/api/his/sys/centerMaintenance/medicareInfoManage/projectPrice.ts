...
export const effectAdjustment = (data: any) => {
    return request({
        url: '/hisapi/feexmfytj01/effectAdjustment',
        method: 'post',
        data,
    })
}
...
export const saveAdjustment = (data: any) => {
    return request({
        url: '/hisapi/feexmfytj01/saveAdjustment',
        method: 'post',
        data,
        headers: {
...
export const updateExcuteStatus = (data: any) => {
    return request({
        url: '/hisapi/feexmfytj01/updateExcuteStatus',
        method: 'post',
        data,
    })
}
...
export const removeAdjustment = (data: any) => {
    return request({
        url: '/hisapi/feexmfytj01/removeAdjustment',
        method: 'post',
        data,
    })
}
...
export const checkDetail = (data: any) => {
    return request({
        url: '/hisapi/feexmfytj01/loadAdjustmentAndDetail',
        method: 'post',
        data,
    })
}
