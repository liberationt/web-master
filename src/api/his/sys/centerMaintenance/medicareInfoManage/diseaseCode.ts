...
export const queryList = (data: any) => {
    return request({
        url: '/hisapi/dicjbbm/tcmQueryPage',
        method: 'post',
        data,
    })
}
...
export const queryTypeList = (data: any) => {
    return request({
        url: '/hisapi/dicjbbm/tcmDropList',
        method: 'post',
        data,
    })
}
...
export const queryRelaList = (data: any) => {
    return request({
        url: '/hisapi/dicjbbm/queryZZList',
        method: 'post',
        data,
    })
}
...
export const syndromPageList = (data: any) => {
    return request({
        url: '/hisapi/dicjbbm/zhQueryPage',
        method: 'post',
        data,
    })
}
