 ...
 * @LastEditors: 曹俊
 * @Description:
 * @FilePath: \web-master\src\api\his\op\guidance\reception\reception.ts
 */
...
export const queryRecept = (data: any) =>
  axios.request({
    url: '/hisapi/hspmn/receptandconsultdict/queryRecept',
    method: 'post',
    data,
  })
...
export const getMaxOrderNo = (data: any) =>
  axios.request({
    url: '/hisapi/hspmn/receptandconsultdict/getMaxOrderNo',
    method: 'post',
    data,
  })
