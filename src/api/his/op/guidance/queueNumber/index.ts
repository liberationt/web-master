...
export const queryDoctorList = (data:any) => {
    return request({
        url: '/hisapi/opzspdxx/queryLoginDoctor',
        data,
        method: 'post'
    })
}
...
export const chooseDoctor = (data:any) => {
    return request({
      url: '/hisapi/opzspdxx/appointDoctor',
      data,
      method: 'post',
    })
}
...
export const callDoctor = (data:any) => {
    return request({
      url: '/hisapi/opzspdxx/callNumber',
      data,
      method: 'post',
    })
}
...
export const queryPatient = (data:any) => {
    return request({
      url: '/hisapi/opzspdxx/getBrdaByBrid',
      data,
      method: 'post',
    })
}
