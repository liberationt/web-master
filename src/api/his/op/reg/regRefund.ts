...
export const aQueryMzxxFpxx = (data: any) => {
  return axios.request({
    url: '/hisapi/opmzxx/doQueryMzxxFpxx',
    method: 'post',
    data
  })
}
...
export const aQueryTFFphm = (data: any) => {
  return axios.request({
    url: '/hisapi/opmzxx/doQueryTFFphm',
    method: 'post',
    data,
    // headers: {
...
export const aQueryTFPayment = (data: any) => {
  return axios.request({
    url: '/hisapi/opmzxx/doQueryTFPayment',
    method: 'post',
    data,
    headers: {
      'Content-Type': 'application/json'
...
export const aSaveRefundSettle = (data: any) => {
  return axios.request({
    url: '/hisapi/opmzxx/doSaveRefundSettle',
    method: 'post',
    data,
    headers: {
      'Content-Type': 'application/json',
