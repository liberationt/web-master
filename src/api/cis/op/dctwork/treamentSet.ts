...
export const aJoinInTreatment = (data: any) => {
  return request({
    url: '/hisapi/msbcjl/saveClinicTherapeutic',
    method: 'post',
    data,
  })
}
