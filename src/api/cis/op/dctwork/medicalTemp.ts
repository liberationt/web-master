...
export const queryDetail = (data: any) => {
  return request({
    url: '/hisapi/gyblmb/getOneByEntity',
    method: 'post',
    data,
  })
}
...
export const tranferIn = (data: any) => {
  return request({
    url: '/hisapi/msbcjl/templateImport',
    method: 'post',
    data,
  })
}