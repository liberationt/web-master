 ...
 */
 ...
 export const queryList = (data: any) => {
   return request({
     url: '/hisapi/opyygh/loadAppointedInfo',
     method: 'post',
     data,
   })
 }
...
export const aCheckModify = (data: any) => {
  return request({
    url: '/hisapi/yygl/checkCanModifyAppointment',
    method: 'post',
    data,
  })
}
...
export const aModifyAppointment = (data: any) => {
  return request({
    url: '/hisapi/yygl/modifyAppointedInfo',
    method: 'post',
    data,
  })
}
