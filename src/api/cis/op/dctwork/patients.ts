...
export const queryPatientList = (data: any) => {
  return request({
    url: '/hisapi/opghmx/queryPatientList',
    method: 'post',
    data
  })
}
...
export const queryPatientFile = (data: any) => {
  return request({
    url: '/hisapi/opghmx/loadClinicInfo',
    method: 'post',
    data
  })
}
...
export const initPatientFile = (data: any) => {
  return request({
    url: '/hisapi/opghmx/saveInitClinicInfo',
    method: 'post',
    data
  })
}
...
export const handleOn = (data: any) => {
  return request({
    url: '/hisapi/msbcjl/saveClinicFinish',
    method: 'post',
    data,
  })
}
...
export const loadInfo = (data: any) => {
  return request({
    url: '/hisapi/msbcjl/loadSettlementInfo',
    method: 'post',
    data,
  })
}
