...
export const queryYjyy4Html = () => {
	return request({
		url: '/hisapi/diczlxm/queryYjyy4Html',
		method: 'post'
	});
};
...
export const queryYjyyData = (data: any) => {
	return request({
		url: '/hisapi/diczlxm/queryYjyyData',
		method: 'post',
		data
	});
};
...
export const loadPatientInfo = (data: any) => {
	return request({
		url: '/hisapi/yygl/loadPatientInfo',
		method: 'post',
		data
	});
};
...
export const loadSqdDetailInfo = (data: any) => {
	return request({
		url: '/hisapi/yygl/loadSqdDetailInfo',
		method: 'post',
		data
	});
};
...
export const queryRecentTimeByHyrq = (data: any) => {
	return request({
		url: '/hisapi/yygl/queryRecentTimeByHyrq',
		method: 'post',
		data
	});
};
...
export const queryRecentTime = (data: any) => {
	return request({
		url: '/hisapi/diczlxm/queryRecentTime',
		method: 'post',
		data
	});
};
...
export const queryYysjView = (data: any) => {
	return request({
		url: '/hisapi/diczlxm/queryYysjView',
		method: 'post',
		data
	});
};
...
export const saveSqdFromMZorZY = (data: any) => {
	return request({
		url: '/hisapi/diczlxm/saveSqdFromMZorZY',
		method: 'post',
		data
	});
};
...
export const queryJcSqdList = (data: any) => {
	return request({
		url: '/hisapi/yygl/queryJcSqdList',
		method: 'post',
		data
	});
};
