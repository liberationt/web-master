...
export const searchDetailList = (data: any) => {
  return request({
    url: '/hisapi/opzt02/BLZbdfhiinstty',
    method: 'post',
    data,
  })
}
...
export const queryDetail = (data: any) => {
  return request({
    url: '/hisapi/opzt02/findListByZtbh',
    method: 'post',
    data,
  })
}
...
export const queryDetailXm = (data: any) => {
  return request({
    url: '/hisapi/opzt02/findListByZtbhXm',
    method: 'post',
    data,
  })
}
...
export const logoutExamineSuiteName = (data: any) => {
  return request({
    url: '/hisapi/lisjyztlx/saveLogoutZtlx',
    method: 'post',
    data,
  })
}
...
export const checkoutData = (data: any) => {
  return request({
    url: '/hisapi/lisjyztlx/queryPage',
    method: 'post',
    data,
  })
}
...
export const sureBtn = (data: any) => {
  return request({
    url: '/hisapi/diczlxm/saveMzjySqd',
    method: 'post',
    data,
    headers: {
      'Content-Type': 'application/json'
