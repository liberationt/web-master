    ...
    try {
        ...
        if (needCLodop()) {
            ...
            if ((!LODOP) || (!LODOP.VERSION)) {
                if (ua.indexOf('Chrome') >= 0)
                    ...
                    window.lodopHTMLData = strHtmChrome
                if (ua.indexOf('Firefox') >= 0)
                    // document.body.innerHTML = strHtmFireFox + document.body.innerHTML;
                    window.lodopHTMLData = strHtmFireFox
                window.lodopHTMLData = strHtmInstall
        ...
        if (LODOP.VERSION < "6.2.2.6") {
            if (!needCLodop())
                ...
                window.lodopHTMLData = strHtmUpdate
                window.flagLodop = !window.flagLodop
        }
