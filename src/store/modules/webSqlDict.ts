 ...
 * @LastEditTime: 2021-05-28 16:30:39
 * @Description:
 * @FilePath: \web-master\src\store\modules\webSqlDict.ts
 */
const webSqlDict = {
  state: {
    TABLE_NO_DICT: [], // 号表字典
    ...
    FY_STYLE_DICT: [], // 发药方式
    SYS_FYFS_DATA: [], // 不带全部的发药方式
    INVENTORY_STATUS_DICT: [], // 完成标识/盘点状态
    ZY_ZH_DICT: [], // 中医证候字典
    ZY_ZD_DICT: [], // 中医诊断字典
    ...
    RETURN_SIGN_DICT: [], //在退标识
    HEALTH_CARE_DICT: [], //保健情况
    HOSPITAL_PROJECT_DICT: [], //住院项目
    ACCOUNT_CATEGORY_DICT: [], //医保账户类别
    REPORTABLE_IDENTIF_DICT: [], //可报标识
    PERSON_TYPE_DICT: [], //人员类型
    REFUND_IDENTIF_DICT: [], //退费标识
    JGZY_IDENTIF_DICT: [], //急观住院标志
    CY_IDENTIF_DICT: [], //出院标志
    TREATMENT_RESULT_DICT: [], //治疗结果
    MZFY_CATEGORY_DICT: [], //门诊费用类别
    ZYFY_CATEGORY_DICT: [], //住院费用类别
    BRXZ_DICT: [], // 门诊建档病人性质
    ...
    SXZ_AREA_DICT: [], //受血者属地
    IM_BXSP_DICT: [], //备血审批状态
    CONSULT_ROOM_DICT: [], //治疗诊室
    EVENT_CATE_DICT: [], // 不良事件类别
    EVENT_NATURE_DICT: [], // 不良事件性质
    EVENT_REPORT_DICT: [], // 不良事件上报标志
    EVENT_EXAMINE_DICT: [], // 不良事件审核标志
    EVENT_RESULT_DICT: [], // 不良事件审核结果
    EVENT_ANALYSIS_DICT: [], // 不良事件分析标志
    OBSERVE_DEPARTMENT_DICT: [], // 门诊留观科室字典
    LGBQ_DICT: [], //留观病区
    ZDY_SIGNDATA_DICT: [], //自定义体征数据
    HIGH_RISK_GRADE_DICT: [], // 高危药品等级
    JBD_HZLX_DICT: [], //交班单患者类型
    JBD_BCLX_DICT: [], //交班单班次类型
    JBD_SBAR_DICT: [], //交班单SBAR类型
    JCKS_DICT: [], //检查科室
    REFERRAL_DICT: [], // 医保转诊
    SKINTESTPROJECT__DICT: [], // 皮试项目
    BAXY_SSLCLJ_DICT: [], //实施临床路径
    MEDICAL_RECORD_DICT: [], //病案首页归并
    PURPOSE_ADMISSION_DICT: [], // 入院目的
    BASY_CYQK_DICT: [], // 病案出院情况
    NURSE_DICT:[],//护士字典
    FJJFFS_DICT: [],//计费方式
    SET_IM_DS_DICT: [],// 滴速字典
  },
  mutations: {
    ...
    //set 完成标识/盘点状态字典
    SET_INVENTORY_STATUS_DICT(state: any, params: any) {
      state.INVENTORY_STATUS_DICT = params
    },
    //set 结束标志
    ...
    // set 不带全部的发药方式
    SET_SYS_FYFS_DATA(state: any, params: any) {
      state.SYS_FYFS_DATA = params
    },
    ...
    // 在退标识
    SET_RETURN_SIGN_DICT(state: any, params: any) {
      state.RETURN_SIGN_DICT = params
    },
    // 保健情况
    SET_HEALTH_CARE_DICT(state: any, params: any) {
      state.HEALTH_CARE_DICT = params
    },
    // 住院项目
    SET_HOSPITAL_PROJECT_DICT(state: any, params: any) {
      state.HOSPITAL_PROJECT_DICT = params
    },
    // 医保账户类别
    SET_ACCOUNT_CATEGORY_DICT(state: any, params: any) {
      state.ACCOUNT_CATEGORY_DICT = params
    },
    // 可报标识
    SET_REPORTABLE_IDENTIF_DICT(state: any, params: any) {
      state.REPORTABLE_IDENTIF_DICT = params
    },
    // 人员类型
    SET_PERSON_TYPE_DICT(state: any, params: any) {
      state.PERSON_TYPE_DICT = params
    },
    // 退费标识
    SET_REFUND_IDENTIF_DICT(state: any, params: any) {
      state.REFUND_IDENTIF_DICT = params
    },
    // 急观住院标志
    SET_JGZY_IDENTIF_DICT(state: any, params: any) {
      state.JGZY_IDENTIF_DICT = params
    },
    // 出院标志
    SET_CY_IDENTIF_DICT(state: any, params: any) {
      state.CY_IDENTIF_DICT = params
    },
    // 治疗结果
    SET_TREATMENT_RESULT_DICT(state: any, params: any) {
      state.TREATMENT_RESULT_DICT = params
    },
    // 门诊费用类别
    SET_MZFY_CATEGORY_DICT(state: any, params: any) {
      state.MZFY_CATEGORY_DICT = params
    },
    // 住院费用类别
    SET_ZYFY_CATEGORY_DICT(state: any, params: any) {
      state.ZYFY_CATEGORY_DICT = params
    },
    // 门诊建档病人性质
    ...
    // 病人情况
    SET_BRQK_DICT(state: any, params: any) {
      state.BRQK_DICT = params
    },
    // 特殊手术
    ...
    // 治疗执行状态字典
    SET_ZXZT_DICT(state: any, params: any) {
      state.ZXZT_DICT = params
    },
    // 受血者属地
    SET_SXZ_AREA_DICT(state: any, params: any) {
      state.SXZ_AREA_DICT = params
    },
    // 备血审批
    SET_IM_BXSP_DICT(state: any, params: any) {
      state.IM_BXSP_DICT = params
    },
    //  诊室字典
    SET_CONSULT_ROOM_DICT(state: any, params: any) {
      state.CONSULT_ROOM_DICT = params
    },
    //  不良事件类别
    SET_EVENT_CATE_DICT(state: any, params: any) {
      state.EVENT_CATE_DICT = params
    },
    //  不良事件性质
    SET_EVENT_NATURE_DICT(state: any, params: any) {
      state.EVENT_NATURE_DICT = params
    },
    //  不良事件上报标志
    SET_EVENT_REPORT_DICT(state: any, params: any) {
      state.EVENT_REPORT_DICT = params
    },
    //  不良事件审核标志
    SET_EVENT_EXAMINE_DICT(state: any, params: any) {
      state.EVENT_EXAMINE_DICT = params
    },
    //  不良事件审核结果
    SET_EVENT_RESULT_DICT(state: any, params: any) {
      state.EVENT_RESULT_DICT = params
    },
    //  不良事件分析标志
    SET_EVENT_ANALYSIS_DICT(state: any, params: any) {
      state.EVENT_ANALYSIS_DICT = params
    },
    //  门诊留观科室字典
    ...
    // 留观结算类型
    SET_IM_LGLX_DICT(state: any, params: any) {
      state.IM_LGLX_DICT = params
    },
    // 留观病区
    SET_LGBQ_DICT(state: any, params: any) {
      state.LGBQ_DICT = params
    },
    // 自定义体温单参数
    SET_ZDY_SIGNDATA_DICT(state: any, params: any) {
      state.ZDY_SIGNDATA_DICT = params
    },
    // 高危药品等级
    SET_HIGH_RISK_GRADE_DICT(state: any, params: any) {
      state.HIGH_RISK_GRADE_DICT = params
    },
    // 交班单患者类型
    SET_JBD_HZLX_DICT(state: any, params: any) {
      state.JBD_HZLX_DICT = params
    },
    // 交班单班次类型
    SET_JBD_BCLX_DICT(state: any, params: any) {
      state.JBD_BCLX_DICT = params
    },
    // 交班单SBAR类型
    SET_JBD_SBAR_DICT(state: any, params: any) {
      state.JBD_SBAR_DICT = params
    },
    // 检查科室
    SET_JCKS_DICT(state: any, params: any) {
      state.JCKS_DICT = params
    },
    // 医保转诊
    ...
    // 皮试项目
    SET_SKINTESTPROJECT__DICT(state: any, params: any) {
      state.SKINTESTPROJECT__DICT = params
    },
    // 实施临床路径
    SET_BAXY_SSLCLJ_DICT(state: any, params: any) {
      state.BAXY_SSLCLJ_DICT = params
    },
    // 住院费用类别
    SET_MEDICAL_RECORD_DICT(state: any, params: any) {
      state.MEDICAL_RECORD_DICT = params
    },
    // 入院目的
    ...
    // 病案出院情况
    SET_BASY_CYQK_DICT(state: any, params: any) {
      state.BASY_CYQK_DICT = params
    },
    // 护士字典
    SET_NURSE_DICT(state: any, params: any) {
      state.NURSE_DICT = params
    },
    // 滴速字典
    SET_IM_DS_DICT(state: any, params: any) {
      state.IM_DS_DICT = params
    },
    // 计费方式
    SET_FJJFFS_DICT(state: any, params: any) {
      state.FJJFFS_DICT = params
    },
  },
  actions: {},
}
